  ...
  useEffect(() => {
    const fetchPostAndComments = async () => {
      try {
        ...
        const responsePost = await axios.get(`https://social-sphere-xzkh.onrender.com/api/v1/posts/${postId}`);
        setPost(responsePost.data);

        // Fetch comments for the post
        const responseComments = await axios.get(`https://social-sphere-xzkh.onrender.com/api/v1/comments/p/${postId}`);
